...
class Ui_settingDialog(object):
    ...
    def retranslateUi(self, settingDialog):
        ...
        self.footnotesExt.setText(QCoreApplication.translate("settingDialog", u"Footnotes", None))
        self.defListsExt.setText(QCoreApplication.translate("settingDialog", u"Definition Lists", None))
        self.mdExt.setText(QCoreApplication.translate("settingDialog", u"Markdown in HTML", None))
        self.supExt.setText(QCoreApplication.translate("settingDialog", u"Superscript", None))
        self.subExt.setText(QCoreApplication.translate("settingDialog", u"Subscript", None))
        self.linkExt.setText(QCoreApplication.translate("settingDialog", u"Auto Detect Links", None))
        self.symbolsExt.setText(QCoreApplication.translate("settingDialog", u"Smart Symbols", None))
        self.strikeExt.setText(QCoreApplication.translate("settingDialog", u"Strike", None))

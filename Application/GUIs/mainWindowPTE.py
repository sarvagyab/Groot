...
"")
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/find.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSearch_in_Current_Note.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/sun_dark.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDark_Theme.setIcon(icon25)
        self.actionDark_Theme.setObjectName("actionDark_Theme")
        self.actionLight_Theme = QtWidgets.QAction(Groot)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/sun_light.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLight_Theme.setIcon(icon26)
        self.actionLight_Theme.setObjectName("actionLight_Theme")
        self.actionBold = QtWidgets.QAction(Groot)
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/bold.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBold.setIcon(icon27)
        self.actionBold.setShortcutVisibleInContextMenu(True)
        self.actionBold.setObjectName("actionBold")
        self.actionItalic = QtWidgets.QAction(Groot)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/italic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionItalic.setIcon(icon28)
        self.actionItalic.setObjectName("actionItalic")
        self.actionUnderline = QtWidgets.QAction(Groot)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/underline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUnderline.setIcon(icon29)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/decrypt.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDecrypt_note.setIcon(icon30)
        self.actionDecrypt_note.setObjectName("actionDecrypt_note")
        self.actionSettings = QtWidgets.QAction(Groot)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSettings.setIcon(icon31)
        self.actionSettings.setObjectName("actionSettings")
        self.actionSave_note = QtWidgets.QAction(Groot)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_note.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/bug.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReport_a_bug.setIcon(icon33)
        self.actionReport_a_bug.setObjectName("actionReport_a_bug")
        self.actionLink = QtWidgets.QAction(Groot)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/link.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLink.setIcon(icon34)
        self.actionLink.setObjectName("actionLink")
        self.actionImage = QtWidgets.QAction(Groot)
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImage.setIcon(icon35)

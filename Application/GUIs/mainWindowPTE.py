...
"")
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/doc_import.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuImport.setIcon(icon17)
        self.menuImport.setObjectName("menuImport")
        self.menuExport = QtWidgets.QMenu(self.menuFile)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/doc_export.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuFormat.setIcon(icon19)
        self.menuFormat.setObjectName("menuFormat")
        self.menuEncrption = QtWidgets.QMenu(self.menuEdit)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/encrypt.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.menuEncrption.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/print.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPrint.setIcon(icon21)
        self.actionPrint.setObjectName("actionPrint")
        self.actionQuit = QtWidgets.QAction(Groot)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/quit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuit.setIcon(icon22)
        self.actionQuit.setObjectName("actionQuit")
        self.actionMD = QtWidgets.QAction(Groot)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/Icons/Format Icons/16x16/markdown.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMD.setIcon(icon23)
        self.actionMD.setObjectName("actionMD")
        self.actionMD_2 = QtWidgets.QAction(Groot)
        self.actionMD_2.setIcon(icon23)
        self.actionMD_2.setObjectName("actionMD_2")
        self.actionHTML = QtWidgets.QAction(Groot)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/Icons/Format Icons/16x16/html.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHTML.setIcon(icon24)
        self.actionHTML.setObjectName("actionHTML")
        self.actionPDF = QtWidgets.QAction(Groot)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icons/Icons/Format Icons/16x16/pdf.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPDF.setIcon(icon25)
        self.actionPDF.setObjectName("actionPDF")
        self.actionSearch_in_Current_Note = QtWidgets.QAction(Groot)
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/find.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSearch_in_Current_Note.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/sun_dark.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDark_Theme.setIcon(icon28)
        self.actionDark_Theme.setObjectName("actionDark_Theme")
        self.actionLight_Theme = QtWidgets.QAction(Groot)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/sun_light.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLight_Theme.setIcon(icon29)
        self.actionLight_Theme.setObjectName("actionLight_Theme")
        self.actionBold = QtWidgets.QAction(Groot)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/bold.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/italic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionItalic.setIcon(icon31)
        self.actionItalic.setObjectName("actionItalic")
        self.actionUnderline = QtWidgets.QAction(Groot)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/underline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionEncrypt_note.setIcon(icon20)
        self.actionEncrypt_note.setObjectName("actionEncrypt_note")
        self.actionDecrypt_note = QtWidgets.QAction(Groot)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/decrypt.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDecrypt_note.setIcon(icon33)
        self.actionDecrypt_note.setObjectName("actionDecrypt_note")
        self.actionSettings = QtWidgets.QAction(Groot)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSettings.setIcon(icon34)
        self.actionSettings.setObjectName("actionSettings")
        self.actionSave_note = QtWidgets.QAction(Groot)
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_note.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/bug.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReport_a_bug.setIcon(icon36)
        self.actionReport_a_bug.setObjectName("actionReport_a_bug")
        self.actionLink = QtWidgets.QAction(Groot)
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/link.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLink.setIcon(icon37)
        self.actionLink.setObjectName("actionLink")
        self.actionImage = QtWidgets.QAction(Groot)
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/image.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImage.setIcon(icon38)
        self.actionImage.setObjectName("actionImage")
        self.actionpermanent_decrypt = QtWidgets.QAction(Groot)
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/cancel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionpermanent_decrypt.setIcon(icon39)
        self.actionpermanent_decrypt.setObjectName("actionpermanent_decrypt")
        self.actionchange_encryption_password_of_note = QtWidgets.QAction(Groot)
        icon40 = QtGui.QIcon()
        icon40.addPixmap(QtGui.QPixmap(":/icons/Icons/16x16/key.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionchange_encryption_password_of_note.setIcon(icon40)
        self.actionchange_encryption_password_of_note.setObjectName("actionchange_encryption_password_of_note")
        ...
        self.menuEncrption.addAction(self.actionpermanent_decrypt)
        self.menuEncrption.addAction(self.actionchange_encryption_password_of_note)
    ...
    def retranslateUi(self, Groot):
        ...
        self.fileName.setText(_translate("Groot", "<html><head/><body><p><span style=\" color:#ffffff;\">No Note Selected</span></p></body></html>"))
        ...
        self.insertFile.setToolTip(_translate("Groot", "Insert image"))
        ...
        self.permanentDecrypt.setToolTip(_translate("Groot", "Permanent decrypt"))
        self.changePasswordButton.setToolTip(_translate("Groot", "Change encryption password of this note"))
        ...
        self.actionpermanent_decrypt.setText(_translate("Groot", "permanent decrypt"))
        self.actionchange_encryption_password_of_note.setText(_translate("Groot", "change encryption password of this note"))
import resource_rc

...
class Ui_Groot(object):
    def setupUi(self, Groot):
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/Icons/16x16/find.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionSearch_in_Current_Note.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/Icons/16x16/info.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/Icons/16x16/sun_dark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDark_Theme.setIcon(icon4)
        self.actionLight_Theme = QAction(Groot)
        self.actionLight_Theme.setObjectName(u"actionLight_Theme")
        icon5 = QIcon()
        icon5.addFile(u":/icons/Icons/16x16/sun_light.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionLight_Theme.setIcon(icon5)
        self.actionBold = QAction(Groot)
        self.actionBold.setObjectName(u"actionBold")
        icon6 = QIcon()
        icon6.addFile(u":/icons/Icons/16x16/bold.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/Icons/16x16/italic.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionItalic.setIcon(icon7)
        self.actionUnderline = QAction(Groot)
        self.actionUnderline.setObjectName(u"actionUnderline")
        icon8 = QIcon()
        icon8.addFile(u":/icons/Icons/16x16/underline.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionUnderline.setIcon(icon8)
        self.actionNew_note = QAction(Groot)
        self.actionNew_note.setObjectName(u"actionNew_note")
        icon9 = QIcon()
        icon9.addFile(u":/icons/Icons/16x16/doc_new.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionNew_note.setIcon(icon9)
        self.actionNew_sub_notebook = QAction(Groot)
        self.actionNew_sub_notebook.setObjectName(u"actionNew_sub_notebook")
        icon10 = QIcon()
        icon10.addFile(u":/icons/Icons/16x16/subfolder.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionNew_sub_notebook.setIcon(icon10)
        self.actionNew_notebook = QAction(Groot)
        self.actionNew_notebook.setObjectName(u"actionNew_notebook")
        icon11 = QIcon()
        icon11.addFile(u":/icons/Icons/16x16/folder_plus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionNew_notebook.setIcon(icon11)
        self.actionEncrypt_note = QAction(Groot)
        self.actionEncrypt_note.setObjectName(u"actionEncrypt_note")
        icon12 = QIcon()
        icon12.addFile(u":/icons/Icons/16x16/encrypt.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionEncrypt_note.setIcon(icon12)
        self.actionDecrypt_note = QAction(Groot)
        self.actionDecrypt_note.setObjectName(u"actionDecrypt_note")
        icon13 = QIcon()
        icon13.addFile(u":/icons/Icons/16x16/decrypt.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDecrypt_note.setIcon(icon13)
        self.actionSettings = QAction(Groot)
        self.actionSettings.setObjectName(u"actionSettings")
        icon14 = QIcon()
        icon14.addFile(u":/icons/Icons/16x16/settings.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionSettings.setIcon(icon14)
        self.actionSave_note = QAction(Groot)
        self.actionSave_note.setObjectName(u"actionSave_note")
        icon15 = QIcon()
        icon15.addFile(u":/icons/Icons/16x16/save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionSave_note.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/icons/Icons/16x16/bug.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReport_a_bug.setIcon(icon16)
        self.actionLink = QAction(Groot)
        self.actionLink.setObjectName(u"actionLink")
        icon17 = QIcon()
        icon17.addFile(u":/icons/Icons/16x16/link.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionLink.setIcon(icon17)
        self.actionImage = QAction(Groot)
        self.actionImage.setObjectName(u"actionImage")
        icon18 = QIcon()
        icon18.addFile(u":/icons/Icons/16x16/image.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionImage.setIcon(icon18)
...
"	border:1px solid blue;\n"
"}")
        self.newNotebook.setIcon(icon11)
...
"	border:1px solid blue;\n"
"}")
        self.newSubNotebook.setIcon(icon10)
...
"}")
        icon19 = QIcon()
        icon19.addFile(u":/icons/Icons/32x32/arrow_top.png", QSize(), QIcon.Normal, QIcon.Off)
        self.prevMatch.setIcon(icon19)
...
"}")
        icon20 = QIcon()
        icon20.addFile(u":/icons/Icons/32x32/arrow_bottom.png", QSize(), QIcon.Normal, QIcon.Off)
        self.nextMatch.setIcon(icon20)
...
"}")
        ...
        icon21 = QIcon()
        icon21.addFile(u":/icons/Icons/32x32/font_bold.png", QSize(), QIcon.Normal, QIcon.Off)
        self.boldButton.setIcon(icon21)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/icons/Icons/32x32/font_italic.png", QSize(), QIcon.Normal, QIcon.Off)
        self.italicButton.setIcon(icon22)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/icons/Icons/32x32/numbered_list.png", QSize(), QIcon.Normal, QIcon.Off)
        self.numberedList.setIcon(icon23)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/icons/Icons/32x32/bullets.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bullets.setIcon(icon24)
...
"}")
        ...
        icon25 = QIcon()
        icon25.addFile(u":/icons/Icons/32x32/link.png", QSize(), QIcon.Normal, QIcon.Off)
        self.link.setIcon(icon25)
        self.link.setIconSize(QSize(32, 32))

        self.horizontalLayout_8.addWidget(self.link)

        self.pushButton_3 = QPushButton(self.insertFrame)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setCursor(QCursor(Qt.PointingHandCursor))
        self.pushButton_3.setStyleSheet(u"")
        icon26 = QIcon()
        icon26.addFile(u":/icons/Icons/32x32/image.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon27 = QIcon()
        icon27.addFile(u":/icons/Icons/32x32/brackets.png", QSize(), QIcon.Normal, QIcon.Off)
        self.code.setIcon(icon27)
...
"}")
        ...
        icon28 = QIcon()
        icon28.addFile(u":/icons/Icons/32x32/encrypt.png", QSize(), QIcon.Normal, QIcon.Off)
        self.encryptionButton.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/icons/Icons/32x32/decrypt.png", QSize(), QIcon.Normal, QIcon.Off)
        self.decryptionButton.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/icons/Icons/32x32/clock.png", QSize(), QIcon.Normal, QIcon.Off)
        self.dateTime.setIcon(icon30)
...
"")
        ...
        icon31 = QIcon()
        icon31.addFile(u":/icons/Icons/16x16/doc_import.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuImport.setIcon(icon31)
        self.menuExport = QMenu(self.menuFile)
        self.menuExport.setObjectName(u"menuExport")
        icon32 = QIcon()
        icon32.addFile(u":/icons/Icons/16x16/doc_export.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuExport.setIcon(icon32)
        self.menuEdit = QMenu(self.menubar)
        self.menuEdit.setObjectName(u"menuEdit")
        self.menuFormat = QMenu(self.menuEdit)
        self.menuFormat.setObjectName(u"menuFormat")
        icon33 = QIcon()
        icon33.addFile(u":/icons/Icons/16x16/edit.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuFormat.setIcon(icon33)
        self.menuEncrption = QMenu(self.menuEdit)
        self.menuEncrption.setObjectName(u"menuEncrption")
        self.menuEncrption.setIcon(icon12)
    ...
    def retranslateUi(self, Groot):
        ...
        self.actionImage.setText(QCoreApplication.translate("Groot", u"Image", None))
        ...
        self.fileName.setText(QCoreApplication.translate("Groot", u"<html><head/><body><p><span style=\" color:#ffffff;\">Testing Name</span></p></body></html>", None))
#if QT_CONFIG(tooltip)
        ...
        self.link.setText("")
#if QT_CONFIG(tooltip)
        self.pushButton_3.setToolTip(QCoreApplication.translate("Groot", u"Insert image", None))
#endif // QT_CONFIG(tooltip)

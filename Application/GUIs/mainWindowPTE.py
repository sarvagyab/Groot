...
"}")
        ...
        self.insertFile.setIcon(icon26)
...
"")
        icon30 = QIcon()
        icon30.addFile(u":/icons/Icons/32x32/cancel.png", QSize(), QIcon.Normal, QIcon.Off)
        self.permanentDecrypt.setIcon(icon30)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/icons/Icons/32x32/key.png", QSize(), QIcon.Normal, QIcon.Off)
        self.changePasswordButton.setIcon(icon31)
        ...
        icon32 = QIcon()
        icon32.addFile(u":/icons/Icons/32x32/clock.png", QSize(), QIcon.Normal, QIcon.Off)
        self.dateTime.setIcon(icon32)
...
"")
        ...
        icon33 = QIcon()
        icon33.addFile(u":/icons/Icons/16x16/doc_import.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuImport.setIcon(icon33)
        self.menuExport = QMenu(self.menuFile)
        self.menuExport.setObjectName(u"menuExport")
        icon34 = QIcon()
        icon34.addFile(u":/icons/Icons/16x16/doc_export.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuExport.setIcon(icon34)
        self.menuEdit = QMenu(self.menubar)
        self.menuEdit.setObjectName(u"menuEdit")
        self.menuFormat = QMenu(self.menuEdit)
        self.menuFormat.setObjectName(u"menuFormat")
        icon35 = QIcon()
        icon35.addFile(u":/icons/Icons/16x16/edit.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuFormat.setIcon(icon35)

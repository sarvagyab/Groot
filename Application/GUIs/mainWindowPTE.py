...
"")
    ...
    def retranslateUi(self, Groot):
        ...
        self.pushButton_5.setText(QCoreApplication.translate("Groot", u"Bold", None))
        self.pushButton_4.setText(QCoreApplication.translate("Groot", u"Italic", None))
        self.pushButton_3.setText(QCoreApplication.translate("Groot", u"Image", None))

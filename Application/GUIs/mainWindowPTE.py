...
" ")
        ...
        self.actionPrint_preview = QAction(Groot)
        self.actionPrint_preview.setObjectName(u"actionPrint_preview")
        icon23 = QIcon()
        icon23.addFile(u":/icons/Icons/16x16/preview.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon26 = QIcon()
        icon26.addFile(u":/icons/Icons/16x16/folder_light.png", QSize(), QIcon.Normal, QIcon.Off)
        font5 = QFont()
        font5.setPointSize(12)
        __qtreewidgetitem = QTreeWidgetItem(self.treeWidget)
        __qtreewidgetitem.setFont(0, font5);
        __qtreewidgetitem.setIcon(0, icon26);
        __qtreewidgetitem1 = QTreeWidgetItem(self.treeWidget)
        __qtreewidgetitem1.setFont(0, font5);
        __qtreewidgetitem1.setIcon(0, icon26);
...
"}")
        ...
        icon27 = QIcon()
        icon27.addFile(u":/icons/Icons/32x32/font_bold.png", QSize(), QIcon.Normal, QIcon.Off)
        self.boldButton.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u":/icons/Icons/32x32/font_italic.png", QSize(), QIcon.Normal, QIcon.Off)
        self.italicButton.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/icons/Icons/32x32/numbered_list.png", QSize(), QIcon.Normal, QIcon.Off)
        self.numberedList.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/icons/Icons/32x32/bullets.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bullets.setIcon(icon30)
...
"}")
        ...
        icon31 = QIcon()
        icon31.addFile(u":/icons/Icons/32x32/link.png", QSize(), QIcon.Normal, QIcon.Off)
        self.link.setIcon(icon31)
        ...
        icon32 = QIcon()
        icon32.addFile(u":/icons/Icons/32x32/image.png", QSize(), QIcon.Normal, QIcon.Off)
        self.insertFile.setIcon(icon32)
        ...
        icon33 = QIcon()
        icon33.addFile(u":/icons/Icons/32x32/brackets.png", QSize(), QIcon.Normal, QIcon.Off)
        self.code.setIcon(icon33)
...
"}")
        ...
        icon34 = QIcon()
        icon34.addFile(u":/icons/Icons/32x32/encrypt.png", QSize(), QIcon.Normal, QIcon.Off)
        self.encryptionButton.setIcon(icon34)
        ...
        icon35 = QIcon()
        icon35.addFile(u":/icons/Icons/32x32/decrypt.png", QSize(), QIcon.Normal, QIcon.Off)
        self.decryptionButton.setIcon(icon35)
...
"")
        icon36 = QIcon()
        icon36.addFile(u":/icons/Icons/32x32/cancel.png", QSize(), QIcon.Normal, QIcon.Off)
        self.permanentDecrypt.setIcon(icon36)
        ...
        icon37 = QIcon()
        icon37.addFile(u":/icons/Icons/32x32/key.png", QSize(), QIcon.Normal, QIcon.Off)
        self.changePasswordButton.setIcon(icon37)
...
"")
        ...
        icon39 = QIcon()
        icon39.addFile(u":/icons/Icons/16x16/doc_import.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuImport.setIcon(icon39)
        self.menuExport = QMenu(self.menuFile)
        self.menuExport.setObjectName(u"menuExport")
        self.menuExport.setFont(font1)
        icon40 = QIcon()
        icon40.addFile(u":/icons/Icons/16x16/doc_export.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuExport.setIcon(icon40)
        ...
        icon41 = QIcon()
        icon41.addFile(u":/icons/Icons/16x16/edit.png", QSize(), QIcon.Normal, QIcon.Off)
        self.menuFormat.setIcon(icon41)
...
#endif // QT_CONFIG(shortcut)
        self.actionPrint_preview.setText(QCoreApplication.translate("Groot", u"Print preview", None))
